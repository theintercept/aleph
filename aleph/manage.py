...
from aleph.logic.roles import create_user, update_roles, delete_role, rename_user, create_group, user_add, user_del
...
def useradd(group, user):
    ...
    if user_role is None:
        raise click.BadParameter("No such user role: %r" % user)
    if group_role is None:
        raise click.BadParameter("No such group role: %r" % group)
